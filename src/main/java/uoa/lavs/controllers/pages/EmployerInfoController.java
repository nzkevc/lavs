...
public class EmployerInfoController extends AnchorPane implements IController {
  ...
  public EmployerInfoController() {
    ControllerUtils.loadFxml(this, "fragments/cards/customer/employer-info.fxml");
  }
}
